...
public class ArrayUtil_Test {
    public static void main(String[] args) {
        ...
        arrayUtility.setIntArray(arrayUtility.removeDuplicates());
        System.out.println("Duplicates Removed: " + arrayUtility.toString());
        arrayUtility.setIntArray(arr10);
        arrayUtility.swapElements(6, 1);
        System.out.println("Index 6 swapped with index 1: " + arrayUtility.toString());
        arrayUtility.setIntArray(arr10);
        arrayUtility.isSorted(true);
        System.out.println("Sorted Array (Ascending): " + arrayUtility.toString());
        arrayUtility.setIntArray(arr10);
        arrayUtility.isSorted(false);
        System.out.println("Sorted Array (Descending): " + arrayUtility.toString());
        System.out.println("-----------------------");
    }
